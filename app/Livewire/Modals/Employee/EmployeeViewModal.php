...
class EmployeeViewModal extends Component
{

    use AsModal;

    public $modal_id = 'employee-view-modal';

    public $modalTitle = 'Employee View';
    // public $name;
    ...
    public function render()
    {
        ...
        return view('livewire.modals.employee.employee-view-modal',[
            'banks' => $banks,
