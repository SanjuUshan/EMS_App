...
class ExportSupervisors implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    ...
    {
        $employeesQueay = Employee::with('bank', 'section')->where('role',EmployerTypeEnum::SUPERVISOR);
